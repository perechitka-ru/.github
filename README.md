# api.perechitka.ru - Микросервисная платформа для онлайн-чтения книг
...
**Web Library** — это **микросервисная архитектура** для создания онлайн-библиотеки. Позволяет пользователям регистрироваться, входить в систему, управлять аккаунтами и читать книги онлайн.
